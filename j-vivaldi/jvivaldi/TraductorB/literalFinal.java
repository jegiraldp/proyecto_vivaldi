...
public class literalFinal {
		 ...
		 * @param metodo metodo
		 * @param entrada1 Entrada
		 * @param entrada2 Entrada
		 * @param ValorentradaA Valor de la entrada
		 * @param ValorentradaB Valor de la entrada
		 */
		public void capturarLiteral(String servicio,String metodo,String entrada1,String entrada2,String ValorentradaA,String ValorentradaB){
			   ...
			   try{
			    URL url = new URL("http://localhost:8080/axis/"+servicio+".jws?method="+metodo+"&"+entrada1+"="+ValorentradaA+"&"+entrada2+"="+ValorentradaB);
